...
<div class="container">
    <section class="article-banner">
        <div class="article-banner__wrap" style="background-image: url(<?= $banner_image["single-post-banner"]; ?>">
    ...
    <?php if ($first_block || $second_block) : ?>
        <?php if ($first_block["description"] || $second_block["description"]) : ?>
            <section class="distance">
                <?php if ($first_block["description"] && $second_block["description"]) : ?>
                    <div class="article-twice-desc__wrap">
                    <?php endif; ?>
                    <div class="article-inner-container__wrap">
                        <div class="article-section__sub-title text-1"><?= $first_block["sub_title"]; ?></div>
                        <div class="article-section-title"><?= $first_block["title"]; ?></div>
                        <div class="article-section-description text-2"><?= $first_block["description"]; ?></div>
                    </div>
                    <div class="article-inner-container__wrap">
                        <div class="article-section__sub-title text-1"><?= $second_block["sub_title"]; ?></div>
                        <div class="article-section-title"><?= $second_block["title"]; ?></div>
                        <div class="article-section-description text-2"><?= $second_block["description"]; ?></div>
                    </div>
                    <?php if ($first_block["description"] && $second_block["description"]) : ?>
                    </div>
                <?php endif; ?>
    ...
    <?php endif; ?>
    <?php if ($third_block) : ?>
        <?php if ($third_block["image"] !== null || $third_block["description"] !== null) : ?>
            <section class="distance">
                <?php if ($third_block["image"] !== null && $third_block["description"] !== null) : ?>
                    <div class="article-twice-desc__wrap with-image">
                    <?php endif; ?>
                    <div class="article-inner-container__wrap image">
                        <img src="<?= $third_block["image"]; ?>" />
                    </div>
                    <div class="article-inner-container__wrap">
                        <div class="article-section__sub-title text-1"><?= $third_block["sub_title"]; ?></div>
                        <div class="article-section-title"><?= $third_block["title"]; ?></div>
                        <div class="article-section-description text-2"><?= $third_block["description"]; ?></div>
                    </div>
                    <?php if ($third_block["image"] && $third_block["description"]) : ?>
                    </div>
                <?php endif; ?>
            </section>
        <?php endif; ?>
    ...
    <div class="recent-posts__container distance">
        ...
        foreach ($post_categories as $category_id) :
            if ($category_id !== 1) :
                ...
                if ($result->have_posts() && $result->found_posts !== 1) : ?>
