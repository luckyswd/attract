                    ...
                    <?php if (!empty($buttons)) : ?>
                        ...
                        <?php if (!empty($socials)) : ?>
                            <div class="socials-wrapper">
                                <a href="https://api.whatsapp.com/send/?phone=48573568893&text&type=phone_number&app_absent=0" target="_blank" class="social-card" rel="nofollow">
                                ...
                                <a href="https://t.me/AttractPartner360" target="_blank" class="social-card" rel="nofollow">
